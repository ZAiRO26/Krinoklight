        ...
        return (
            <div className="min-h-screen bg-background-dark flex items-center justify-center">
                <div className="text-center">
                    ...
                    <p className="text-neutral-slate mb-8">The service you're looking for doesn't exist.</p>
            ...
            <section className="mesh-bg pt-32 pb-20 relative overflow-hidden">
                ...
                <div className="container-custom relative z-10">
                    <div className="text-center max-w-4xl mx-auto">
                        <FadeUp>
                            <div className={`icon-container mx-auto mb-6 bg-gradient-to-br ${svc.gradient}`}>
                                <Icon className="w-8 h-8 text-white" />
                            </div>
                        </FadeUp>
                        <FadeUp delay={0.1}>
                            <h1 className="section-title text-white mb-4">{svc.title}</h1>
                        </FadeUp>
                        <FadeUp delay={0.2}>
                            <p className="text-xl text-neutral-slate mb-8">{svc.subtitle}</p>
                        </FadeUp>
                        <FadeUp delay={0.3}>
