          ...
          <FadeUp>
            ...
            >
              ...
              <div className="space-y-6">
                ...
                <p className="text-lg text-neutral-slate">{featuredPost.excerpt}</p>

                <div className="flex items-center gap-6 text-sm text-neutral-slate">
              ...
              <motion.button
                ...
                className={`px-5 py-2 rounded-full font-medium text-sm transition-all duration-300
                  ${selectedCategory === category
                    ? 'bg-gradient-to-r from-navy-secondary to-accent-cyan text-white shadow-glow-sm'
              ...
              <AnimatedItem key={post.id}>
                ...
                >
                  ...
                  <div className="space-y-3">
                    ...
                    <h3 className="text-lg font-bold text-white group-hover:text-accent-cyan transition-colors line-clamp-2">
                      {post.title}
                    </h3>
                    <p className="text-neutral-slate text-sm line-clamp-2">{post.excerpt}</p>

                    <div className="flex items-center justify-between pt-2">
                      <div className="flex items-center gap-1 text-xs text-neutral-slate">
                        <Clock className="w-3 h-3" />
                        <span>{post.readTime}</span>
                      </div>
                      <Link
                        to={`/insights/blog/${post.id}`}
                        className="text-accent-cyan hover:text-white font-medium text-sm flex items-center gap-1 transition-colors"
                      >
                        Read more
            ...
            {newsletters.map((newsletter, index) => (
              <AnimatedItem key={index}>
                ...
                >
                  ...
                  <h3 className="text-xl font-bold text-white mb-3">{newsletter.title}</h3>
                  <p className="text-neutral-slate mb-6 flex-grow">{newsletter.description}</p>
                  <div className="flex items-center justify-between text-sm text-neutral-slate mb-6">
