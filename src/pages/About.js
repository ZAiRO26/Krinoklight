    ...
    <div className="min-h-screen bg-background-dark">
      ...
      <section className="section-padding mesh-bg">
        <div className="container-custom">
          <AnimatedSection className="text-center mb-16">
            <AnimatedItem>
              <p className="text-accent-cyan font-medium tracking-widest uppercase mb-4">Life at FreekiWebsite</p>
            </AnimatedItem>
            <AnimatedItem>
              <h2 className="section-title text-white mb-6">
      ...
      <section className="section-padding bg-gradient-to-br from-navy-primary via-navy-secondary to-accent-cyan relative overflow-hidden">
        ...
        <div className="container-custom relative z-10">
          <AnimatedSection className="text-center">
            <AnimatedItem>
              <h2 className="section-title text-white mb-6">
                Join Our <span className="text-background-dark">Team</span>
              </h2>
            </AnimatedItem>
            <AnimatedItem>
