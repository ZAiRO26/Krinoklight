...
const NavLink = ({ path, children }) => {
    ...
    return (
        <Link
            to={path}
            className="inline-flex items-center gap-1 px-3 py-1.5 mt-2 bg-blue-600/30 hover:bg-blue-600/50 border border-blue-500/50 rounded-lg text-blue-300 hover:text-white text-sm transition-all"
        >
            ...
            <AnimatePresence>
                {!isOpen && (
                    <motion.button
                        ...
                        whileTap={{ scale: 0.95 }}
                        onClick={toggleChat}
                        className="fixed bottom-6 right-6 z-50 w-14 h-14 bg-gradient-to-r from-blue-600 to-cyan-500 rounded-full shadow-lg shadow-blue-500/30 flex items-center justify-center group"
                    >
                        <MessageCircle className="w-6 h-6 text-white" />
                        <span className="absolute w-full h-full rounded-full bg-blue-500 animate-ping opacity-30" />
                    </motion.button>
                )}
            </AnimatePresence>
            ...
            <AnimatePresence>
                {isOpen && (
                    <motion.div
                        ...
                        className="fixed bottom-6 right-6 z-50 w-[380px] max-w-[calc(100vw-2rem)] bg-gradient-to-b from-gray-900 to-gray-950 rounded-2xl shadow-2xl shadow-blue-900/20 border border-gray-800/50 overflow-hidden flex flex-col"
                    >
                        {/* Header */}
                                ...
                                <div className="p-3 border-t border-gray-800/50 bg-gray-900/50">
                                    <div className="flex items-center space-x-2">
                                        <input
                                            ...
                                            className="flex-1 bg-gray-800/50 border border-gray-700/50 rounded-xl px-4 py-2.5 text-sm text-white placeholder-gray-500 focus:outline-none focus:border-blue-500/50 transition-colors disabled:opacity-50"
                                        />
                                        <motion.button
                                            ...
                                            className="w-10 h-10 bg-gradient-to-r from-blue-600 to-cyan-500 rounded-xl flex items-center justify-center disabled:opacity-50 disabled:cursor-not-allowed"
                                        >
